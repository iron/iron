...
use format::FormatText::{Method, RemoteAddr, RequestTime, ResponseTime, Status, Str, URI};
...
impl Logger {
    ...
    fn log(&self, req: &mut Request, res: &Response) -> IronResult<()> {
        ...
        {
            let render = |fmt: &mut Formatter, text: &FormatText| match *text {
